# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2019-08-11 15:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send_type', models.CharField(choices=[('register', '\u6ce8\u518c'), ('forget', '\u5fd8\u8bb0\u5bc6\u7801')], max_length=8, verbose_name='\u7c7b\u578b')),
                ('send_time', models.DateTimeField(default=datetime.datetime(2019, 8, 11, 23, 11, 28, 203000))),
            ],
            options={
